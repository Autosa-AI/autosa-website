...
type InputFieldProps = FormFieldProps & InputHTMLAttributes<HTMLInputElement> & { textarea?: false };
type TextareaFieldProps = FormFieldProps & TextareaHTMLAttributes<HTMLTextAreaElement> & { textarea: true };
type Props = InputFieldProps | TextareaFieldProps;

export default function FormField(props: Props) {
  const { label, error, required, hint, textarea, ...rest } = props as Props & { textarea?: boolean };
