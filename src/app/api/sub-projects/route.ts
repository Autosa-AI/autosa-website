...
import type { SubProject, ServiceSlug } from "@/lib/models";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { service, name, description, responsibleAdminId, githubUrl, backendGithubUrl, uiUrl, backendServerUrl } = body as {
      service?: string;
      name?: string;
      description?: string;
