  ...
  return (
    <div className="px-4 py-6 sm:p-8 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-white text-2xl font-bold tracking-tight">Admins</h1>
                  ...
                  <tr key={a._id} className={`transition-colors ${isSelf ? "bg-[#c8905a]/[0.04]" : "hover:bg-white/[0.015]"}`}>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-1 justify-end">
                        ...
                        {!isSelf && !isOtherOwner && (
                          <button onClick={() => setConfirmToggle(a)} title={a.isActive ? "Deactivate" : "Activate"}
                            className={`p-1.5 rounded-lg transition-all ${a.isActive
                        ...
                        {!isSelf && !isOtherOwner && (
                          <button onClick={() => setConfirmDelete(a)} title="Delete permanently"
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl border border-white/10 bg-[#111111] p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <FormField label="Email" required type="email" value={createForm.email}
                ...
                placeholder="jane@autosa.net" error={createErrors.email} />
          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl border border-white/10 bg-[#111111] p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <FormField label="Email" required type="email" value={editForm.email}
                ...
                placeholder="jane@autosa.net" error={editErrors.email} />
              <div>
      ...
      {confirmToggle && (
        <ConfirmModal
          ...
          message={`${confirmToggle.isActive ? "Deactivating" : "Activating"} ${confirmToggle.name}. ${confirmToggle.isActive ? "They will no longer be able to log in." : "They will regain access."}`}
      ...
      {confirmDelete && (
        <ConfirmModal
          ...
          message={`This will permanently remove ${confirmDelete.name} (${confirmDelete.email}). This cannot be undone.`}
          danger
